-- 20240721000000_fix_budget_functions_exclude_transactions.sql
-- Fix the budget functions to properly exclude transactions where excluded_from_monthly_budget = true
