...
begin
  ...
  loop
    ...
    -- Copy the corresponding sector budget period (spent amounts will be calculated by update function)
    ...
    select 
      ...
      p_to_month,
      budget_amount,
      0, -- Will be calculated by update function
      0, -- Will be calculated by update function
      0, -- Will be calculated by update function
      now(),
      now()
    ...
    -- Update the spent amounts for this sector
